...
// ✅ Fetch joined employee-payroll-attendance data
$sql = "SELECT
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($salary <= 0) {
        ...
        $sqlInsert = "INSERT INTO [transaction] 
                     (EM_NAME, PAY_TYPE, SALARY, DEDUCTIONS, NET_SAL, PAY_DATE, receipt)
                      VALUES (?, ?, ?, ?, ?, GETDATE(), ?)";
...
<div class="container">
    ...
    <div class="content">
        <form action="" method="post">
            <input type="text" name="user" id="user" placeholder="Employee Name" required><br>
            <input type="number" name="payment_amount" id="payment_amount" placeholder="Salary Amount" required><br>
    ...
    <div class="application-table">
        ...
        <table>
            ...
            <?php
            if ($transactionHistoryResult !== false && sqlsrv_has_rows($transactionHistoryResult)) {
